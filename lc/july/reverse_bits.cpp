...
public:
    ...
    /*
        Using increment operator to set bit and right shift operator to consume n.
    */
    uint32_t reverseBits_simple(uint32_t n) {
        uint32_t result = 0;
        for (int i=0; i<32; ++i)
        {
            result <<= 1;
...
int main()
{
    ...
    cout << s.reverseBits_simple(n) << endl; // expected 964176192 (00111001011110000010100101000000)
